...
#define STRING_CONFIG_H_AUTHOR "ScottB" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "THUNDER DOME"
 ...
 * Each linear axis gets its own  per control and endstop:
 *
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -33, -3.8 }
...
#define PREHEAT_2_FAN_SPEED   84 // Value from 0 to 255
